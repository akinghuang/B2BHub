<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucLog.ascx.cs" Inherits="MW.DataHub.Portal.Console.wuc.wucLog" %>
<style type="text/css">
    .div01
    {
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="width: 280px; padding-left: 40px;">
                <img src="../Image/Images/MWlogo.png" width="250px" height="70px" alt="" />
            </td>
            <td>
            <div class="div01">
