<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="DIMERCO.B2B.Portal.Default1" Title="Dimerco B2B Platfrom Management Console" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="width: 20%; padding-left: 40px;">
                    <img src="Image/Images/logo.png" width="200px" height="56px" alt="" />
                </td>
                <td style="padding-left: 20px; position: relative; top: 17px;" valign="middle">
                    <span class="title01">Dimerco B2B Platform Management Console</span>
                </td>
                <td width="400px"></td>
            </tr>
