<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucNotification.ascx.cs"
    Inherits="DIMERCO.B2B.Portal.Console.wuc.wucNotification" %>
...
<script type="text/javascript">
    ...
    function trOnclik(e)
    {
         ...
         $("#dialog").dialog({width:700,close: function( event, ui ){var objTr=$(".tr02").get(0);$(objTr).attr("class","");}}).parent().appendTo("form");
