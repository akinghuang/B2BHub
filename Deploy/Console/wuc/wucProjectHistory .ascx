<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucProjectHistory .ascx.cs" Inherits="DIMERCO.B2B.Portal.Console.wuc.wucProjectHistory" %>
...
<table border="0" id="tableProjectHistory" cellpadding="0" cellspacing="0" class="table01" width="100%">
<tr class="trHead">
<td>Task</td>
<td>Run Time</td>
<td>Run End</td>
...
<asp:Repeater runat="server" ID="rptProjectHistory">
<ItemTemplate>
<tr>
        <td><%#Eval("TaskName") %></td>
