<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucSelectFrame.ascx.cs"
    Inherits="DIMERCO.B2B.Portal.Console.wuc.wucSelectFrame" %>
...
<div id="tabs">
  <ul style="height:35px;">
    ...
    <li><a href="#fragment-1" style="height:15px;" ><span style="font-size:14px;font-family:Arial">Tasks</span></a></li>
